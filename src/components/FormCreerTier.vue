    ...
    <form class="form-body" @submit.prevent="emit('submit')">
      ...
      <section class="form-section">
        ...
        <div class="field-group">
          ...
          <input
            ...
            @input="patch('raison_sociale', ($event.target as HTMLInputElement).value)"
          />
        ...
        <div class="field-group">
          ...
          <div class="select-wrapper">
            <select
              ...
              @change="patch('types_tiers_id', Number(($event.target as HTMLSelectElement).value))"
            >
            ...
            <!-- Chevron ou spinner selon l'état -->
            <svg v-if="!loadingTypes" class="select-chevron" viewBox="0 0 20 20" fill="currentColor">
      ...
      <section class="form-section">
        ...
        <div class="field-group">
          ...
          <div class="input-wrapper">
            ...
            <input
              ...
              @input="patch('adresse', ($event.target as HTMLInputElement).value)"
            />
          </div>
        ...
        <div class="field-group">
          ...
          <div class="input-wrapper">
            <svg class="input-icon" viewBox="0 0 20 20" fill="currentColor">
              <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0
            ...
            <input
              ...
              @input="patch('num_tel', ($event.target as HTMLInputElement).value)"
            />
          </div>
...
// ─────────────────────────────────────────────────────────────────────
//  TierForm.vue  –  Composant 100 % présentationnel
//  ➜ Aucune logique API, aucun store, aucun onMounted
//  ➜ Toute la logique métier est gérée par le parent (CreateTier.vue)
// ─────────────────────────────────────────────────────────────────────

// ── Types exportés (réutilisables par le parent) ─────────────────────

/** Option d'un type de tiers (ex : Client, Fournisseur…) */
...
const props = withDefaults(defineProps<{
  ...
  /** Options du select « Type de Tiers » */
  typesTiers?: TypeTierOption[]
  /** true pendant la récupération des types (désactive le select) */
...
function patch<K extends keyof TierFormData>(key: K, value: TierFormData[K]) {
