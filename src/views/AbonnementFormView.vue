      ...
      <div v-else class="abonnement-form-card">
        ...
        <form class="form-body" @submit.prevent="handleSubmit">
          ...
          <section class="form-section">
            <h3 class="section-label"><span class="section-dot" />Contrat</h3>
            ...
            <div class="field-row">
              ...
              <!-- Tarif -->
              <div class="field-group">
                <label class="field-label">Tarif <span class="required-star">*</span></label>
                <div class="input-wrapper">
                  <svg class="input-icon" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd"
          ...
          <!-- ── SECTION : Période ─────────────────────────── -->
          <section class="form-section">
            <h3 class="section-label"><span class="section-dot" />Période</h3>

            <div class="field-row">

              <!-- Date début -->
              <div class="field-group">
                <label class="field-label">Date de début <span class="required-star">*</span></label>
                <div class="input-wrapper">
                  <svg class="input-icon" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd"
                      d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0
                         002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1
                         0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1
              ...
              <!-- Date fin -->
              <div class="field-group">
                <label class="field-label">Date de fin <span class="required-star">*</span></label>
                <div class="input-wrapper">
                  <svg class="input-icon" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd"
                      d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0
                ...
                <svg v-else class="btn-icon" viewBox="0 0 20 20" fill="currentColor">
                  <path fill-rule="evenodd"
                    d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0
                       ...
                       l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                </svg>
